...
class phpthumb_functions
{
    ...
    public static function version_compare_replacement_sub($version1, $version2, $operator = '')
    {
        ...
        $version1 = ($versiontype_lookup[$version1] ?? $version1);
        $version2 = ($versiontype_lookup[$version2] ?? $version2);
    ...
    public static function CleanUpURLencoding($url, $queryseperator = '&')
    {
        ...
        foreach ($queries as $key => $query) {
            [$param, $value] = array_pad(explode('=', $query), 2, '');
    ...
    public static function EnsureDirectoryExists($dirname, $mask = 0o755)
    {
